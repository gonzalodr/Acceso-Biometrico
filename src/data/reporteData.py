    ...
    def list_reportes(
        ...
        try:
            ...
            for (
                ...
                registros
            ):  # Se iteran los registros obtenidos y se convierten en objetos de tipo Perfil
                reporte = Reporte(
                ...
                listaReportes.append(
                    {"reporte": reporte, "nombre_empleado": registro["nombre_persona"]}
                )  # Se añade el perfil a la lista
