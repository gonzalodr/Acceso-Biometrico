    ...
    def create_rol_empleado(self, id_empleado: int, id_rol: int, conexionEx=None):
        ...
        try:
            with conexion.cursor() as cursor:
                ...
                return {
                    "success": True,
                    "message": "Se asigno el rol al empleado correctamente",
            ...
            return {
                "success": False,
                "message": "Ocurrió un error al asignar el rol al empleado",
            }
        finally:
            if conexion and conexionEx is None:
                conexion.close()

    def update_rol_empleado(
        self, id_rolEmpleado: int, id_empleado: int, id_rol: int, conexionEx=None
    ):
        conexion, resultado = (
            conection() if conexionEx is None else (conexionEx, {"success": True})
        )
        ...
        try:
            ...
            return {
                "success": False,
                "message": "Ocurrió un error al actualizar el rol del empleado.",
            }
        finally:
            if conexion and conexionEx is None:
                conexion.close()
    ...
    def delete_rol_empleado(self, id_rolempleado: int, conexionEx=None):
        ...
        try:
            with conexion.cursor() as cursor:
                ...
                return {
                    "success": True,
                    "message": "Se elimino el rol asignado al empleado correctamente.",
                }
        except Error as e:
            logger.error(f"{e}")
            return {
                "success": False,
                "message": "Ocurrió un error al eliminar el rol asignado al empleado.",
            }
        finally:
            if conexion and conexionEx is None:
                conexion.close()
            ...
            with conexion.cursor(dictionary=True) as cursor:
                ...
                if data:
                    ...
                    return {
                        "success": True,
                        "exists": False,
                        "message": "No se obtuvo los datos del rol empleado.",
                    }
        except Error as e:
            logger.error(f"{e}")
            return {
                "success": False,
                "message": "Ocurrió un error al obtener el rol asignado del empleado",
            }
        finally:
            if conexion and conexionEx is None:
                conexion.close()
            ...
            with conexion.cursor(dictionary=True) as cursor:
                ...
                if data:
                    ...
                    return {
                        "success": True,
                        "exists": False,
                        "message": "No se obtuvo el rol asignado al empleado.",
                    }
        except Error as e:
            logger.error(f"{e}")
            return {
                "success": False,
                "message": "Ocurrió un error al obtener el rol asignado al empleado",
            }
        finally:
            if conexion and conexionEx is None:
                conexion.close()
