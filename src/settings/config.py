...
TBSOLICITUDPERMISOS = 'solicitud_permiso'
TBSOLICITUDPERMISOS_ID = 'Id'
TBSOLICITUDPERMISOS_ID_EMPLEADO = 'Id_Empleado'
TBSOLICITUDPERMISOS_TIPO = 'Tipo'
TBSOLICITUDPERMISOS_FECHA_INICIO = 'Fecha_Inicio'
TBSOLICITUDPERMISOS_FECHA_FIN = 'Fecha_Fin'
TBSOLICITUDPERMISOS_DESCRIPCION = 'Descripcion'
TBSOLICITUDPERMISOS_ESTADO = 'Estado'