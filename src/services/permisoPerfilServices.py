...
class PermisosRolServices:
    ...
    def listar_permisos_perfil(self,pagina=1, tam_pagina=10, ordenar_por = TBPERMISOROL_ID, tipo_orden="ASC", busqueda = None):
    ...
    def verificar_permiso_perfil_tabla(self, perfil_id:int, tabla:str, id:int =0):
        return self.permisorperfildata.verificar_perfil_permiso(rol_id=rol_id,tabla=tabla,id=id)
